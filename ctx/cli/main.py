"""Click CLI root for ctx — Workspace Context Switcher."""
...
@click.group()
@click.version_option(package_name="ctx")
def cli() -> None:
    """ctx — record and replay developer workspace setups."""
...
def list_workspaces() -> None:
    ...
    if not workspaces:
        click.echo("No workspaces saved yet. Use 'ctx record <name>' to start.")
        return
