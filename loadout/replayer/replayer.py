...
_REPLAY_LOG_PATH = _LOADOUT_DIR / "replay.log"
...
class Replayer:
    ...
    def _handle_browser_tab_open(self, index: int, action: dict[str, Any]) -> None:
        ...
        from loadout.adapters.wm.app_names import BROWSER_APP_NAMES
    ...
    def _handle_ide_project_open(self, index: int, action: dict[str, Any]) -> None:
        ...
        from loadout.adapters.wm.app_names import IDE_APP_NAMES
        client = action.get("client", "")
    ...
    def _handle_terminal_session_consolidated(self, index: int, session_id: str, session: dict) -> None:
        ...
        """
        from loadout.adapters.wm.app_names import TERMINAL_APP_NAMES
